...
This Agreement supplements the [One Ziko Terms of Service] and [Refunds, Returns & Reconciliation Policy]. In case of conflict, this Agreement controls for Seller-specific matters.

---

## 1. Definitions

- **“Kalulu Books”** – the online bookstore platform operated by One Ziko.
- **“Seller”** – you (the person or entity listing books for sale).
- **“Buyer”** – a customer purchasing a book through Kalulu Books.
- **“New Book”** – a physical book in brand new, unused condition, with no defects, markings, or damage. Digital books are always considered new.
...
To become a Seller on Kalulu Books, you must:

- Be at least **16 years old** (the legal age to obtain a National Registration Card in Zambia, and the minimum age to enter into a binding contract under Zambian law).
- Have the legal right to sell the books you list (e.g., you are the copyright holder, have a license from the publisher, or are an authorised distributor).
- Provide accurate identity and payment information (mobile money number or bank account).
- Agree to comply with this Agreement and all applicable laws (including consumer protection, tax, and copyright laws).

One Ziko reserves the right to reject any Seller application or suspend any account at its sole discretion.
...
For each book you list, you must provide:

| **Field** | **Requirement** |
| :--- | :--- |
| Title and author(s) | Accurate and complete |
| Format | Physical or Digital (specify file type for digital) |
| Condition | **New** (only new books permitted – no used, reconditioned, or unboxed) |
...
You may **not** list:
- Books that are counterfeit, pirated, or infringe any third-party intellectual property.
- Books containing illegal content (hate speech, child exploitation, incitement to violence).
- Books that violate One Ziko’s [Terms of Service] (e.g., defamatory, obscene under Zambian law).
- Digital books that contain malware or spyware.
- Used or second‑hand books of any kind.

We may remove any listing that violates this Agreement without prior notice.

### 3.3 Pricing and Changes
You set the price for each new book. You may change the price at any time, but price changes do not affect orders already placed. One Ziko may offer site-wide discounts or coupons; the discount will be deducted from the Sales Proceeds before calculating your payout (unless we agree otherwise in writing).
...
### 5.2 Defective Digital Books
If a Buyer reports a defective digital book (e.g., corrupted file, missing pages), you must provide a replacement file within 2 business days. If replacement is not possible or you do not respond, One Ziko will refund the Buyer and deduct the amount from your earnings.

### 5.3 Dispute Resolution
If a Buyer escalates a dispute to One Ziko (e.g., book never arrived, wrong item), we will investigate. We may request evidence from both parties. Our decision is final. If we rule in favour of the Buyer, we will refund the Buyer from your pending earnings (or invoice you if earnings are insufficient).

---

## 6. Fees, Commissions, and Payouts

### 6.1 Commission Structure
One Ziko deducts a **total commission of 10%** from the Sales Proceeds of each sale. Sales Proceeds include the book price and any **prepaid delivery fee** (if the Buyer chose that option). Pay‑upon‑delivery courier fees are not part of Sales Proceeds.

The commission is broken down as:

| **Component** | **Percentage** | **Recipient / Purpose** |
| :--- | :--- | :--- |
| Turnover Tax (TOT) | **5%** | Remitted by One Ziko to the Zambia Revenue Authority (ZRA) as required by law. |
| Platform Commission | **5%** | Retained by One Ziko for providing the marketplace, payment processing, and support. |

**Example (prepaid delivery):** Book price ZMW 100 + prepaid delivery fee ZMW 20 = Sales Proceeds ZMW 120. Commission = ZMW 12 (ZMW 6 TOT, ZMW 6 platform). Your payout = ZMW 108.

**Example (collection or pay‑upon‑delivery):** Sales Proceeds = book price only (ZMW 100). Commission = ZMW 10. Your payout = ZMW 90. (You receive courier payment separately if pay‑upon‑delivery.)

### 6.2 No Additional Fees
There are no listing fees, subscription fees, or hidden charges. The only deduction is the 10% commission described above.

### 6.3 Calculation of Payout
Your payout = (Book price + any prepaid delivery fee) – (that total × 10%) – any refunds or chargebacks.

Pay‑upon‑delivery courier fees are collected by the courier directly and are not processed by One Ziko.

### 6.4 Payout Schedule
Payouts are made **monthly** (on the 15th of each month) for all confirmed sales from the previous calendar month that are no longer in the return window (i.e., physical books: 30 days after delivery or collection; digital books: 7 days after purchase). We reserve the right to hold payouts for 30 days for new Sellers (under 30 days active).

### 6.5 Payment Method
We pay via **mobile money** (Airtel, MTN, Zamtel) or **bank transfer** (Zambian banks). You must provide accurate payment details. We are not liable for payments sent to incorrect information you provided.

---

## 7. Taxes

**Turnover Tax (TOT)** – The 5% deducted from your Sales Proceeds is remitted by One Ziko directly to the Zambia Revenue Authority (ZRA) on your behalf. You will receive a monthly statement showing the TOT deducted and remitted. This satisfies your TOT obligations for sales made through Kalulu Books, but you remain responsible for any other taxes (e.g., income tax) as required by law.

If you are a non‑Zambian Seller, no TOT is deducted (unless you have a Zambian tax presence). Instead, you are responsible for your local taxes. Contact us if this applies to you.

---

## 8. Content and Intellectual Property

### 8.1 Your License to One Ziko
By listing a book, you grant One Ziko a non‑exclusive, royalty‑free, worldwide license to:

- Display your book’s title, cover image, description, and price on Kalulu Books.
- Promote your book via email, social media, or other marketing channels (with your consent).
- For digital books, host and deliver the file to Buyers.

This license ends when you delist the book or close your Seller account, except for copies needed for backup or to complete pending orders.

### 8.2 Your Warranties
You warrant that:
- You own or have the legal right to sell each new book you list.
- Your book does not infringe any third-party copyright, trademark, or other right.
- Your book does not violate any law or this Agreement.

If a third party claims infringement, you agree to indemnify One Ziko as set out in Section 10.
...
You may close your Seller account at any time by contacting `kalulubooks@oneziko.com`. You must fulfil all pending orders before closure. Any unpaid earnings will be paid out after the return window for your last orders has expired (up to 60 days).
...
Upon termination, all pending payouts may be withheld to cover potential refunds or chargebacks.
...
### 10.1 Limitation
To the fullest extent permitted by law, One Ziko’s total liability to you arising out of this Agreement shall not exceed the total platform commissions paid to us by you in the 12 months preceding the claim (i.e., the 5% portion, not including TOT). We are not liable for any indirect, consequential, or special damages (e.g., lost profits, lost reputation).

### 10.2 Indemnification
You agree to indemnify and hold harmless One Ziko and its officers, employees, and agents from any claim, loss, liability, or expense (including legal fees) arising out of:
- Your breach of this Agreement (e.g., copyright infringement).
- Your book’s content.
- Your failure to comply with tax or consumer laws.

---

## 11. Governing Law and Dispute Resolution

This Agreement is governed by the laws of **Zambia**. Any dispute arising out of this Agreement shall first be attempted to be resolved informally by contacting `kalulubooks@oneziko.com`. If not resolved within 30 days, either party may bring a claim exclusively in the courts of **Lusaka, Zambia**.

For Sellers located outside Zambia, you also consent to the jurisdiction of Zambian courts, but we may seek injunctive relief in your local courts if needed.

---

## 12. Changes to This Agreement

We may update this Agreement from time to time. Material changes (e.g., commission rates, payment schedules, return obligations) will be notified by email to the address associated with your Seller account at least **30 days** in advance. Your continued listing of books after the effective date constitutes acceptance. If you do not agree, you must close your Seller account before the changes take effect.
